...
export async function login(password) {
  ...
  await ensureSchema();
  // Housekeeping: purge expired sessions so the table doesn't grow forever.
  try { await db.execute(`DELETE FROM admin_sessions WHERE expires_at <= datetime('now')`); } catch {}
